...
public class MyUserDAOImplTest {
    ...
    public void add()throws NoSuchAlgorithmException {
        ...
        myUser.setStudentGroup(groupDAO.getGroupById(1));
        myUser.setUserName("fff");
        myUser.setUserSeccondname("fafaf");
        myUser.setUserSurname("afasf");
        myUser.setUserType(personDAO.getUserTypeById(1));
    ...
    public void edit()throws NoSuchAlgorithmException{
        ...
        myUser.setUserSeccondname("nameUserTestEdit");
        userDAO.editUser(myUser);
    }
    @Test
    public void list()throws NoSuchAlgorithmException{
        List<MyUser> list = userDAO.list();
